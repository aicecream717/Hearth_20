...
player2 = create_player(player1.name)
player2.name="AI"
player2.player_name="AI"
            ...
            if event.button == 1:
                ...
                if not CARD_SELECTED and player.side==1:        
                    ...
                    #When turn ends 
                        ...
                        database.insert_event(player,entity="Curse",target=None,event_pos=event.pos,event_type="end turn")
                        player.negative_emote()
                        board.end_turn=True
                    elif board.positive_emote_button.collidepoint(event.pos):
                        database.insert_event(player,entity="Well Played",target=None,event_pos=event.pos,event_type="end turn")
                        player.positive_emote()
                        board.end_turn=True      
                    elif board.end_turn_button.collidepoint(event.pos):
                        database.insert_event(player,entity=None,target=None,event_pos=event.pos,event_type="end turn")
                        board.end_turn=True
