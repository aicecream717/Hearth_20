...
@author: shan.jiang
'''
import requests,re,shutil,database

#Suuply URL for a specific card
card="Searing_Totem"
...
reg_image_file = open('images/card_images/'+card_name+'.png', 'wb')
...
try: 
    ...
    gold_image_file = open('images/card_images/'+card_name+'_gold.png', 'wb')
    response.raw.decode_content = True
...
try:
    ...
    full_image_file = open('images/card_images/'+card_name+'_full.png', 'wb')
    response.raw.decode_content = True
